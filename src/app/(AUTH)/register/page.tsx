...
export default function RegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        // full_name is cleanly piped to raw_user_meta_data so handle_new_user() SQL function can access it
        ...
        <div className="min-h-screen bg-white text-neutral-900 px-6 py-12 flex flex-col justify-center items-center antialiased">
            <div className="w-full max-w-sm flex flex-col gap-8">
                ...
                <form onSubmit={handleRegister} className="flex flex-col gap-4">
                    ...
                    >
                        {loading ? "Generating Profile..." : "Claim identity"}
                    </button>
                </form>
                ...
                <p className="text-sm font-semibold tracking-tight text-neutral-400 text-center">
                    Have an account?{" "}
                    <Link href="/login" className="text-emerald-950 hover:underline">
                        Log in →
                    </Link>
                </p>
